    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('metered_feature', models.ForeignKey(
                    related_name='consumed', to='silver.MeteredFeature', on_delete=models.CASCADE)),
            ],
        ),
        migrations.CreateModel(
            name='Plan',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('invoice', models.ForeignKey(
                    related_name='related_invoice', blank=True, to='silver.Invoice', null=True, on_delete=models.SET_NULL)),
            ],
            options={
                'ordering': ('-issue_date', 'number'),
                'abstract': False,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('customer', models.ForeignKey(related_name='subscriptions',
                 to='silver.Customer', help_text='The customer who is subscribed to the plan.', on_delete=models.CASCADE)),
                ('plan', models.ForeignKey(
                    help_text='The plan the customer is subscribed to.', to='silver.Plan', on_delete=models.CASCADE)),
            ],
        ),
        migrations.AddField(
            model_name='proforma',
            name='provider',
            field=models.ForeignKey(to='silver.Provider', on_delete=models.CASCADE),
        ),
        migrations.AddField(
            model_name='plan',
            name='product_code',
            field=models.OneToOneField(
                ...
                help_text='The product code for this plan.', on_delete=models.CASCADE),
        ),
        migrations.AddField(
            model_name='plan',
            name='provider',
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(
                ...
                to='silver.Subscription', on_delete=models.CASCADE),
        ),
        migrations.AddField(
            ...
            field=silver.utils.models.UnsavedForeignKey(
                ...
                to='silver.ProductCode', on_delete=models.CASCADE),
        ),
        migrations.AddField(
            model_name='invoice',
            name='proforma',
